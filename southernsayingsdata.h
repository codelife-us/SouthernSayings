...
const std::vector<Saying> southernSayings = {
    ...
    {true,"Couldn't pour water out of a boot with instructions on the heel", "A humorous way to describe someone as incredibly incompetent or dim-witted"},
    {true,"Not the brightest crayon in the box", "A gentle, humorous way to say someone isn't very smart or quick-witted"},
    ...
    {false,"He's married, but the fence still has a few holes in it", "Suggesting infidelity or lack of commitment"},
    ...
    {true,"He's silly as all get-out", "Utmost silliness. Get-out is used in other ways in the South to mean to the utmost conceivable degree"},
